        ...
        <section className="w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6">
                ...
                <Link
                    ...
                    className="group lg:col-span-3 relative flex flex-col justify-end min-h-72 sm:min-h-80 rounded-3xl overflow-hidden border border-transparent hover:border-emerald-100 transition-all duration-300"
                >
                    {featuredImageUrl ? (
                        <>
                            <Image
